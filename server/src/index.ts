...
/* ROUTES */
app.use("/dashboard", authenticateToken([1,2,3,4]), dashboardRoutes) //http://localhost:8000/dashboard
app.use("/products", authenticateToken([1,2,4]),productRoutes) //http://localhost:8000/products
app.use("/product-types", authenticateToken([1,2,4]), productTypeRoutes) //http://localhost:8000/product-types
...
app.use("/purchases", authenticateToken([1,2,3]), purchaseRoutes) //http://localhost:8000/purchases
app.use("/purchase-details", authenticateToken([1,2,3]), purchaseDetailsRoutes) //http://localhost:8000/purchase-details
app.use("/sales", authenticateToken([1,2,4]), saleRoutes) //http://localhost:8000/sales
app.use("/sale-details", authenticateToken([1,2,4]), saleDetailsRoutes) //http://localhost:8000/sale-details
app.use("/clients", authenticateToken([1,2]), clientRoutes) //http://localhost:8000/clients
